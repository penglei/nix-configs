...
M.buf = function(buf)
  local plug_map = {
    ...
    ["n|<C-t>"] = map_cr("NeotestRun"):with_buffer(buf):with_noremap():with_silent():with_desc("Neotest: Run cursor nearest test"),
    ["n|<leader>t<CR>"] = map_cr("NeotestRun"):with_buffer(buf):with_noremap():with_silent():with_desc("Neotest: Run cursor nearest test"),
