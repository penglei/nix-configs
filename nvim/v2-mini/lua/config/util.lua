...
function bind.map_cr(cmd_string)
	return keymap_options:new():map_cr(cmd_string)
end

---@return keymap_options
function bind.map_cmd(cmd_string)
	return keymap_options:new():map_cmd(cmd_string)
end

---@return keymap_options
function bind.map_cu(cmd_string)
	return keymap_options:new():map_cu(cmd_string)
end

---@return keymap_options
function bind.map_args(cmd_string)
	return keymap_options:new():map_args(cmd_string)
end

---@return keymap_options
function bind.map_callback(callback)
	return keymap_options:new():map_callback(callback)
end
