...
--- [wilder.nvim , snack.input] or [noice.nvim]
...
local popup_style_config = vim.tbl_deep_extend("force", config, command_line_popup)
---@diagnostic disable-next-line: unused-local
local noice_config = popup_style_config
