...
in rustPlatform.buildRustPackage rec {
  ...
  src = fetchFromGitHub {
    owner = "alacritty";
    repo = pname;
    rev = "a4af47426ab697098fd2b39df944a1ec9d3952ad";
    hash = "sha256-RtoWosp28Z4GGJOydw9/+LpB8TUAAxse8R7AJo0Z+DQ=";
  };

  cargoSha256 = "sha256-6ylXCMQpM2FJgdSY21RSyD/jGREGNpaZbuJ305jnKNk=";
